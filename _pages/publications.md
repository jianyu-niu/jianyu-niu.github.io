...
The following lists a selection of my recent publications. For a complete list, please refer to my [Google Scholar](https://scholar.google.com/citations?user=2BakBVcAAAAJ&hl=en) and [DBLP](https://dblp.org/pid/161/2037.html). (Notation: * Corresponding author; _ Supervised student; † Equal contribution.)
...
_IEEE Transactions on Dependable and Secure Computing_, 2026.   
[[Homepage with
 Animation ]](https://ebftalgorithm.github.io/) [[One variant used in VeChain]](https://github.com/vechain/VIPs/blob/master/vips/VIP-220.md) [[Selected as reading list by Stanford EE374]](http://web.stanford.edu/class/ee374/)  
...
Shlomi Dolev, Bingyong Guo, **Jianyu Niu**, and Ziyu Wang (**Alphabetically ordered**)  
_IEEE Transactions on Dependable and Secure Computing_, 2023.  
