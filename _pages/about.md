...
1.  **<sub>[EuroS&P'19]</sub> SgxPectre: Stealing Intel Secrets from SGX Enclaves via Speculative Execution**  
...
1. **<sub>[S&P'18]</sub> Racing in Hyperspace: Closing Hyper-Threading Side Channels on SGX with Contrived Data Races**  
...
1. **<sub>[INFOCOM'18]</sub> Differentially Private Access Patterns for Searchable Symmetric Encryption**  
...
1. **<sub>[CCS'17]</sub> Leaky Cauldron on the Dark Land: Understanding Memory Side-Channel Hazards in SGX**  
...
1. **<sub>[ICDCS'17]</sub> EV-Matching: Bridging Large Visual Data and Electronic Data for Efficient Surveillance**  
...
1. **<sub>[INFOCOM'16]</sub> Flash-Loc: Flashing Mobile Phones for Accurate Indoor Localization**  
...
1. **<sub>[ICDCS'15]</sub> Crowd-ML: A Privacy-Preserving Learning Framework for a Crowd of Smart Devices**  
...
1. **<sub>[MoBiData'15]</sub> Mobile Data Collection Frameworks: A Survey**  
Paul Y. Cao, Gang Li, **Guoxing Chen**, Biao Chen  
_Workshop on Mobile Big Data_, Hangzhou, China, Jun. 2015.
1. **<sub>[SAM'14]</sub> Detecting the Vulnerability of Multi-Party Authorization Protocols to Name Matching Attacks**  
...
1. **<sub>[WCL'12]</sub> On Degrees of Freedom of Cognitive Networks with User Cooperation**  
